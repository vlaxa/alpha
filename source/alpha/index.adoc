...
* link:raspberry-pi.adoc[*Raspberry Pi*] (model 2 and 3 is supported)


=== Desktop Platform

* link:macos.adoc[*macOS*] (version 10.10+ is supported)
* link:ubuntu.adoc[*Ubuntu Desktop*] (version 16.04 LTS is supported)
* link:windows.adoc[*Windows*] (version 7, 8.x & 10 is supported)
